...
class Object(object):
    ...
    def __init__(self):
        if self.isLogin == True and self.showLoginD == True:
            self.log("[%s] : ล็อกอินแล้ว!" % self.profile.displayName)
            self.log("โทเค่น : %s" %self.authToken)
            self.sendMessage("u889d8baf7acda3c395c83e48d1dde770","Logged in.")
    """Group"""
